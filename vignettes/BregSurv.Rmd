...
- **Mahalanobis distance with external curvature** (analog of [§2.3](#sec_coxmaha)): `ncc_MDTL()` / `cv.ncc_MDTL()`, with `_enet` variants. Takes the external $\widetilde{\boldsymbol{\beta}}$ plus its covariance/precision matrix `vcov`.
