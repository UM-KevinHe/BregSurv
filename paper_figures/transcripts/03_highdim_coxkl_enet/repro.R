...
# Generated:    2026-05-27T23:56:25.853880Z
# User query:   High-dimensional Cox cohort at /gpfs/accounts/kevinhe_root/kevinhe1/ybshao/BregSurv-mcp/data/ExampleData_highdim.rda. ExampleData_highdim$train has `z` with 50 covariates, plus `time` and `status`.
...
r1_args <- list(data_path = "/gpfs/accounts/kevinhe_root/kevinhe1/ybshao/BregSurv-mcp/data/ExampleData_highdim.rda", z_expr = "ExampleData_highdim$train$z", time_expr = "ExampleData_highdim$train$time", delta_expr = "ExampleData_highdim$train$status", eta = 0.5, beta_expr = "ExampleData_highdim$beta_external", alpha = 1.0, lambda_ = NULL, nlambda = 100, tol = 0.0001, Mstop = 1000)
